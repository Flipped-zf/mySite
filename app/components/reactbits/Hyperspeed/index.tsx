...
class App {
  ...
  dispose() {
    ...
    if (this.road.leftRoadWay) {
      this.road.leftRoadWay.geometry.dispose()
      disposeMaterials(this.road.leftRoadWay.material)
    }
    if (this.road.rightRoadWay) {
      this.road.rightRoadWay.geometry.dispose()
      disposeMaterials(this.road.rightRoadWay.material)
    }
    if (this.road.island) {
      this.road.island.geometry.dispose()
      disposeMaterials(this.road.island.material)
    }
    if (this.leftCarLights.mesh) {
      this.leftCarLights.mesh.geometry.dispose()
      this.leftCarLights.mesh.material.dispose()
    }
    if (this.rightCarLights.mesh) {
      this.rightCarLights.mesh.geometry.dispose()
      this.rightCarLights.mesh.material.dispose()
    }
    if (this.leftSticks.mesh) {
      this.leftSticks.mesh.geometry.dispose()
      this.leftSticks.mesh.material.dispose()
    }
  ...
  tick() {
    ...
    if (
      resizeRendererToDisplaySize(this.renderer, this.setSize, this.container)
    ) {
